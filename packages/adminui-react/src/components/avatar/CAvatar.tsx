...
export interface CAvatarProps extends HTMLAttributes<HTMLDivElement> {
  ...
  className?: string
  /**
   * Sets the color context of the component to one of AdminUI’s themed colors.
   *
  ...
  src?: string
  /**
   * Sets the color context of the status indicator to one of AdminUI’s themed colors.
   *
   * @type 'primary' | 'secondary' | 'success' | 'danger' | 'warning' | 'info' | 'dark' | 'light' | string
   */
  status?: Colors
  /**
   * Sets the text color of the component to one of AdminUI’s themed colors.
   *
